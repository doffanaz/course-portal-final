...
// Check if we are running in placeholder mode (real values not populated yet)
export const isPlaceholderFirebase = 
...
// Initialize Auth & Firestore with correct Database ID
